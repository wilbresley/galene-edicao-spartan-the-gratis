...
3. **`/admin/`** — painel (usuários, convites, bloqueados, temporários, logs, oscilações, salas). Login com o mesmo visual da home. **Não** sirvas o admin em `/`.
