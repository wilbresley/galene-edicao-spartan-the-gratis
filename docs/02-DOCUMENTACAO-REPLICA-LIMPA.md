...
3. **`/admin`** — painel. Arquivo `static/admin`, não pasta. **Não** sirvas o admin em `/`.
...
| `/salas/` | Outras salas |
| `/admin` | Painel (arquivo `static/admin`) |
